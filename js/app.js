...
RULES = {
	...
	three : {
		...
		rule : 'Take one drink, give one drink'
	},
	four : {
		name : 'Thumb Master',
		rule : 'Whoever has this card can put there thumb on the table and the last player to put his/her thumb on the table has to drink, then the thumb master can take it off, then whoever the last to take it off has to drink, this card is good until another 4 is picked.'
	},
	five : {
		name : 'Rule ',
